...
INPUT_PATH = path.sep.join([BASE_PATH, "datasets/fer2013/fer2013.csv"])
...
# HDF5 files
TRAIN_HDF5 = path.sep.join([BASE_PATH, "datasets/hdf5/train.hdf5"])
VAL_HDF5 = path.sep.join([BASE_PATH, "datasets/hdf5/val.hdf5"])
TEST_HDF5 = path.sep.join([BASE_PATH, "datasets/hdf5/test.hdf5"])
